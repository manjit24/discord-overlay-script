    ...
    const config = {
        info: {
            ...
            authors: [
                {
                    name: "tgoyal63",
                    discord_id: "518470816258588684",
                    github_username: "tgoyal63",
                    twitter_username: "tgoyal63"
                }
            ],
            version: "1.1.0",
            description: "Adds an Icon to channels that copies <#channelId>. Shift + Click to insert the channel in the textarea.",
            github: "https://github.com/Strencher/BetterDiscordStuff/blob/master/LinkChannels/LinkChannelss.plugin.js",
            github_raw: "https://raw.githubusercontent.com/Strencher/BetterDiscordStuff/master/LinkChannels/LinkChannelss.plugin.js"
        },
        changelog: [
            {
                title: "added",
        ...
        load() {
            BdApi.showConfirmationModal("Library plugin is needed", 
                [`The library plugin needed for ${config.info.name} is missing. Please click Download Now to install it.`], {
                    ...
                    cancelText: "Cancel",
                    onConfirm: () => {
                        require("request").get("https://rauenzi.github.io/BDPluginLibrary/release/0PluginLibrarys.plugin.js", async (error, response, body) => {
                            if (error) return require("electron").shell.openExternal("https://betterdiscord.net/ghdl?url=https://raw.githubusercontent.com/rauenzi/BDPluginLibrary/master/release/0PluginLibrarys.plugin.js");
                                ...
                                children: React.createElement(LinkIcon, {
                                    ...
                                    onClick: (e) => {
                                        if (e.shiftKey) insertText("<#" + props.channel.id + ">")
                                            ...
                                            DiscordModules.ElectronModule.copy("https://streamkit.discord.com/overlay/voice/" + props.channel.guild_id + "/" + props.channel.id + "?icon=true&online=true&logo=white&text_color=%23ffffff&text_size=14&text_outline_color=%23000000&text_outline_size=0&text_shadow_color=%23000000&text_shadow_size=0&bg_color=%231e2124&bg_opacity=0.95&bg_shadow_color=%23000000&bg_shadow_size=0&invite_code=maisamayhoon&limit_speaking=True&small_avatars=True&hide_names=false&fade_chat=0");
